...
BREW_PACKAGES=(git gh node ripgrep fd fzf starship eza bat zoxide uv tmux graphviz clang-uml plantuml cmake pre-commit clang-format ninja doxygen quarto ccache ffmpeg btop hexyl sevenzip)
