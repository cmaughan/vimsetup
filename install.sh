...
printf "  ${YELLOW}2.${NC} Open tmux and press ${BOLD}prefix + I${NC} to install tmux plugins\n"
printf "  ${YELLOW}3.${NC} Neovim will auto-install plugins on first launch -- just let it finish\n"
printf "  ${YELLOW}4.${NC} In each git repo with a ${BOLD}.pre-commit-config.yaml${NC}, run: ${BOLD}pre-commit install${NC}\n"
printf "\n"
